...
Gname = [cfg.dir 'Touch_SA_allspectra_allpts_0205.mat'];
...
bigexport = zeros([numel(cfg.sub)*62*size(cfg.fband,1),7]);
c = 0;
...
for freqi = 1:size(cfg.fband,1)
    ...
    participantIDs=repmat(participantIDs,1,62)';
    elIDs = [1:62];
...
electrodeNames={'Fp1','Fpz','Fp2','AF7','AF3','AF4','AF8','F7','F5','F3','F1','Fz','F2','F4','F6','F8','FT7','FC5','FC3','FC1','FCz','FC2','FC4','FC6','FT8','T7','C5','C3','C1','Cz','C2','C4','C6','T8','TP7','CP5','CP3','CP1','CPz','CP2','CP4','CP6','TP8','P7','P5','P3','P1','Pz','P2','P4','P6','P8','PO7','PO3','POz','PO4','PO8','O1','Oz','O2','F9','F10'};
...
%=========================================================================
epochs = cfg.epochTime*1000;
outname = [cfg.dir 'AllERD_SA_allpts_theta_' num2str(epochs(1)) '-' num2str(epochs(2)) 'ms_' d '.xlsx'];
